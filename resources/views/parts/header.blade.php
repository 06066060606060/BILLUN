            ...
            <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']"
                ...
                <div class="-mx-4 lg:flex lg:items-center">
                    <a href="/" class=" block mx-4 py-2 font-black text-[color:var(--bg-color)] ">Sécurité pour le
                        Web</a>
                    <a href="secure_mail" class=" block mx-4 py-2 mt-4 font-black  lg:mt-0 text-gray-600  hover:text-[#6002E9] ">Sécurité
                        pour E-mail</a>
                    <select title="lang" name="lang"
                        class="bg-[#F8F8F8] inline-block h-7 md:h-12 px-3 py-1 ml-5 md:ml-2 leading-normal no-underline whitespace-no-wrap align-middle select-none font-bold text-gray-400  border-l-[3px] border-gray-300"
                        id="lang">
